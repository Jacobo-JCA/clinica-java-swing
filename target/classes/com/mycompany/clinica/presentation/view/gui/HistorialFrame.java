...
import com.mycompany.clinica.presentation.view.gui.utils.GenericSwingWorker;
...
import com.mycompany.clinica.presentation.view.gui.utils.HistorialData;
...
//    private void cargarConsultas(List<Consultation> consultas) {
//        modeloTablaConsulta.setRowCount(0);
...
//    }
//
//    private void cargarSignosVitales(List<Consultation> consultas) {
//        modeloTablaSignos.setRowCount(0);
//        for (Consultation consulta : consultas) {
//            for (VitalSigns signos : consulta.getSignosVitales()) {
...
//    }
//
//    private void cargarEnfermedades(List<HealthStatus> enfermedades) {
//        modeloTablaEnfermedad.setRowCount(0);
//        for (HealthStatus enfermedad : enfermedades) {
