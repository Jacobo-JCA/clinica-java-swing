...
public class VitalSignsFrame extends javax.swing.JDialog implements View {
    private VitalSignsController signosController;
    private SesionContexto sesionContexto;
    
    public VitalSignsFrame(java.awt.Frame parent, boolean modal, VitalSignsController signoVitalController, SesionContexto sesionContexto) {
        super(parent, modal);
...
//            VitalSigns signos = signosController.convertirDatosSignoVital(campos);
//            sesionContexto.setSignosVitales(signos);
//            NotificationMessage.mostrarConfirmacion("Se han ingresado los datos de Signos Vitales!!");
//            this.dispose();
