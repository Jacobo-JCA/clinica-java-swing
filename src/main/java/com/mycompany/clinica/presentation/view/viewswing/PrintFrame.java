...
//            Patient paciente = sesionContexto.getPaciente();
//            JasperReport report = null;
//            Map<String, Object> parameters = new HashMap<>();
//            if(paciente == null) {
//                MensajeInformativo.mostrarError("No hay Paciente!");
//            }
//            List<Consultation> consultas = paciente.getListConsultas();
//            if (consultas == null || consultas.isEmpty()) {
//                MensajeInformativo.mostrarError("No hay consultas registradas para este paciente.");
//                return;
//            }
//            consultas.sort(Comparator.comparing(Consultation::getFechaConsulta).reversed());
...
//            
//            Consultation ultimaConsulta = consultas.get(0);
