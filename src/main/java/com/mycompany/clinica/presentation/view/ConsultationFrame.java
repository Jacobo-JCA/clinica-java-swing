 ...
 * @author jacob
 */
public class ConsultationFrame extends javax.swing.JDialog implements View {
    private ConsultationController consulaController;
    
    public ConsultationFrame(java.awt.Frame parent, boolean modal, ConsultationController consultaController) {
        super(parent, modal);
...
//            NotificationMessage.mostrarConfirmacion("Consulta validada. Los datos se guardarán al registrar el paciente.");
//            this.dispose();
//        } catch (Exception e) {
