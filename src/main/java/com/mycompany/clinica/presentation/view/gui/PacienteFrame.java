...
import com.mycompany.clinica.presentation.view.gui.utils.ControllerFactory;
...
public class PacienteFrame extends javax.swing.JInternalFrame {
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if (fila == -1) {
            MensajeInformativo.mostrarError("Seleccione un paciente");
            return;
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        ConsultaController consultaController = controllerFactory.crearConsultaController();
    ...
    private void btnPatologicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPatologicoActionPerformed
        ControllerFactory controllerFactory = ControllerFactory.getInstance();
        EnfermedadController enfermedadController = controllerFactory.crearEnfermedadController();
    ...
    private void btnSignosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignosActionPerformed
        ControllerFactory controllerFactory = ControllerFactory.getInstance();
        SignoVitalController signosController = controllerFactory.crearSignoVitalController();
    ...
    public List<String> obtenerCamposPaciente() {
