...
public class ConsultationController {
    ...
    private final ConsultationFrame consultaFrame;
    
    public ConsultationController(ConsultationService consultaService, SesionContexto sesionContext) {
        this.consultaService = consultaService;
        this.sesionContext = sesionContext;
        this.consultaFrame = new ConsultationFrame(null, true, this);
    }
