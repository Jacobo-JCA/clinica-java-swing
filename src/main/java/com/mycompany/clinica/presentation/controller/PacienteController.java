...
public class PacienteController {
    ...
    private Paciente convertirFormularioAEntidad(List<String> campos) {
        ...
        Paciente paciente = new Paciente(campos.get(0), campos.get(1), campos.get(2), campos.get(3), campos.get(4), 
        Period.between(fechaNacimiento, LocalDate.now()).getYears(), campos.get(5), Integer.parseInt(campos.get(6)),
        campos.get(7), campos.get(8), fechaNacimiento, campos.get(10), campos.get(11));
