...
public class Paciente {   
    ...
    private List<Consultation> listConsultas = new ArrayList<>();
    ...
    public List<Consultation> getListConsultas() {
        return listConsultas;
    }

    public void setListConsultas(List<Consultation> listConsultas) {
        this.listConsultas = listConsultas;
    }
    
    public void addConsultas(Consultation consulta) {
